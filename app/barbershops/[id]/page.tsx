...
const BarbershopPage = async (props: PageProps<"/barbershops/[id]">) => {
  ...
  return (
    <>
      <div className="flex size-full flex-col items-start overflow-clip gap-6 mt-19 lg:grid container mx-auto lg:grid-cols-[1.5fr_1fr]">
        ...
        <div className="h-100 w-full">
          ...
          <div>
            <div className="flex w-full items-center gap-1.5 px-5 pt-6 pb-0 rounded-t-lg">
        ...
        {/* Container Principal */}
        <div className="bg-background w-full flex-1 rounded-tl-3xl rounded-tr-3xl rounded-b-3xl">
          ...
          {/* Contato */}
          <div className="flex w-full flex-col items-start gap-3 px-5 pb-6">
            <div className="flex items-center justify-center gap-2.5">
              <p className="text-foreground text-xs font-bold uppercase">
                CONTATO
              </p>
